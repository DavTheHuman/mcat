...
const fileNameForTrack = (track)=> path.join(MUSIC_DIR, `/${track.artistsTitle}/${track.release.title}/${track.title}${track.version == "" ? `` : ` ${track.version}`}.mp3`)
const fileNameForAlbumArt = (track)=> path.join(MUSIC_DIR, `/${track.artistsTitle}/${track.release.title}/folder.jpg`)
const fileNameForRelease = (release) => path.join(MUSIC_DIR, `/${release.artistsTitle}/${release.title}/${release.title}.zip`)
const fileNameForReleaseArt = (release) => path.join(MUSIC_DIR, `/${release.artistsTitle}/${release.title}/folder.jpg`)
